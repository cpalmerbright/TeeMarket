...
class BatchesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create batch" do
    assert_difference('Batch.count') do
      post batches_url, params: { batch: { color: @batch.color, fabric: @batch.fabric, manufacturer_id: @batch.manufacturer_id, quantity: @batch.quantity } }
    end
  ...
  test "should update batch" do
    patch batch_url(@batch), params: { batch: { color: @batch.color, fabric: @batch.fabric, manufacturer_id: @batch.manufacturer_id, quantity: @batch.quantity } }
